...
| `ipa_redhat_com` | `/etc/krb5.conf.d/ipa_redhat_com` | 0644 | Kerberos IPA realm config |
| `00-distgit-bastion.conf.j2` | `/etc/ssh/ssh_config.d/00-distgit-bastion.conf` | 0444 | SSH bastion configuration |
| `known-hosts-rh-ldap.sh` | `/usr/local/bin/known-hosts-rh-ldap` | 0755 | LDAP-based SSH known hosts |
